package wallDecorationModule
{
	...
	public class CDecorationModuleImp implements ICDecorationModule
	{
		...
		private function doLoadMeshSuccess(mesh:L3DMesh,loader:L3DLoadHelper):void
		{
			...
			(_taskDic[loader] as CDecorationTaskVO).mesh=mesh;
		}
		private function doCreateWaist(textureResource:L3DBitmapTextureResource,loader:L3DLoadHelper):void
		{
			loader.removeEventListener(Event.COMPLETE,onLoadComplete);
			var taskVo:CDecorationTaskVO=_taskDic[loader] as CDecorationTaskVO;
			switch(taskVo.type)
			{
				case Object3DDict.OBJECT3D_WAIST:
					var waists:Array=getPaths(taskVo);
		...
		private function getPaths(taskVo:CDecorationTaskVO):Array
		{
			return null;
		}
			...
			CONFIG::isDecoration
				{
					...
					{
						var vo:CDecorationTaskVO=taskVo as CDecorationTaskVO;

package main.a3d.support
{
	...
	public class CScene3D extends Object3D
	{
		...
		public function CScene3D(container:DisplayObjectContainer, stage:Stage , isDebug:Boolean=true)
		{
			...
			if(_stage3D.visible)
			{
				...
				for (tmp = childrenList; tmp != null; tmp = tmp.next)
				{
					if(tmp is IRenderAble)
						(tmp as IRenderAble).render(stage3D,_nowTime);
				}
				
				if(enterFrameCallBack!=null)
					enterFrameCallBack.call(null,stage3D,_nowTime);
			}
